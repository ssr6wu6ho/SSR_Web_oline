...
import { CodeIcon, CircuitBoardIcon, ChevronRight } from 'lucide-vue-next';
...
const skills = [
  {
    name: 'SOFTWARE',
    tech: [
      { name: 'Vue.js', level: 55, color: 'bg-green-500' },
      { name: 'Springboot', level: 20, color: 'bg-blue-500' },
      { name: 'Android', level: 45, color: 'bg-purple-500' },
      { name: 'python-opencv', level: 35, color: 'bg-pink-500' }
    ],
  },
  {
    name: 'HARDWARE',
    tech: [
      { name: 'MQTT', level: '55', color: 'bg-green-500' },
      { name: 'Arduino', level: 65, color: 'bg-yellow-500' },
      { name: 'Esp8266/32', level: 60, color: 'bg-red-500' },
      { name: 'Linux', level: 45, color: 'bg-orange-500' },
    ],
  },
];
//SVG图标
