<template>
  <div class="flex ">
    <div class="rounded-lg border backdrop-blur-sm overflow-hidden" :class="[slideBarExtendStore.musicBarExtend ? 'w-96' : 'w-30', slideBarExtendStore.musicBarExtend ? 'h-full' : 'h-20',
